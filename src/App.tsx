    ...
    return <>
        ...
        <div className="App">
            <ReactFullpage
                ...
                anchors={["home", "why-us", "staff", "footer"]}
                navigation={true}
                scrollingSpeed={1000}
                            ...
                            <div className="relative z-10 w-full max-w-6xl mx-auto text-slate-900">
                                <div className="flex flex-col gap-8 md:gap-12">
                                    <div className="text-center">
                                        <div className="mx-auto w-12 h-1 bg-brand-red mb-4 md:mb-6" />
                                        ...
                                        <p className="mt-3 text-sm md:text-base text-slate-600 max-w-2xl mx-auto leading-relaxed">
                                            {t('staff.subtitle') || 'Our team'}
                                        </p>
                                    </div>

                                    <div className="w-full flex flex-col items-center">
                                        {/* Primary (largest) card: Administration */}
                                        <div className="w-full max-w-3xl">
                                            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 md:p-8">
                                                <h3 className="text-xl md:text-2xl font-extrabold text-slate-900 mb-5 text-center">{t('staff.admin.title')}</h3>
                                                <ul className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm md:text-base text-slate-700">
                                                    <li className="flex flex-col items-center text-center">
                                                        <span className="font-semibold">Rudi Zhang <span className="font-normal text-slate-500">1326158</span></span>
                                                        <span className="text-slate-500">{t('staff.admin.role_chairman')}</span>
                                                    </li>
                                                    <li className="flex flex-col items-center text-center">
                                                        <span className="font-semibold">Xinrui Wan <span className="font-normal text-slate-500">1897662</span></span>
                                                        <span className="text-slate-500">{t('staff.admin.role_gm')}</span>
                                                    </li>
                                                    <li className="flex flex-col items-center text-center">
                                                        <span className="font-semibold">Junzhe Yan <span className="font-normal text-slate-500">1340265</span></span>
                                                        <span className="text-slate-500">{t('staff.admin.role_deputy_gm')}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6 justify-center">
                                                ...
                                                <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6">
                                                    ...
                                                    <ul className="space-y-3 text-sm text-slate-700">
                                                        <li className="flex flex-col items-center text-center">
                                                            <span className="font-semibold">Jiashu Ye <span className="font-normal text-slate-500">1679151</span></span>
                                                            <span className="text-slate-500">{t('staff.flight.role_ops')}</span>
                                                        </li>
                                                        <li className="flex flex-col items-center text-center">
                                                            <span className="font-semibold">Haoyu Wu <span className="font-normal text-slate-500">1621162</span></span>
                                                ...
                                                {/* Dispatch */}
                                                <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6">
                                                    <h3 className="text-lg font-bold text-slate-900 mb-4 text-center">{t('staff.dispatch.title')}</h3>
                                                    <ul className="space-y-3 text-sm text-slate-700">
                                                        <li className="flex flex-col items-center text-center">
                                                            <span className="font-semibold">Lihan Bao <span className="font-normal text-slate-500">1435267</span></span>
                                                            <span className="text-slate-500">{t('staff.dispatch.role_dispatcher')}</span>
                                                        </li>
                                                        <li className="flex flex-col items-center text-center">
                                                            <span className="font-semibold">Jingyuan Yin <span className="font-normal text-slate-500">1478847</span></span>
                                                            <span className="text-slate-500">{t('staff.dispatch.role_dispatcher')}</span>
                                                        </li>
                                                        <li className="flex flex-col items-center text-center">
                                                            <span className="font-semibold">Steven Zhang <span className="font-normal text-slate-500">1752734</span></span>
                                                            <span className="text-slate-500">{t('staff.dispatch.role_dispatcher')}</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                {/* Design */}
                                                <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6">
                                                    <h3 className="text-lg font-bold text-slate-900 mb-4 text-center">{t('staff.design.title')}</h3>
                                                    <ul className="space-y-3 text-sm text-slate-700">
                                                        <li className="flex flex-col items-center text-center">
                                                            <span className="font-semibold">Shengbo Yang <span className="font-normal text-slate-500">1676022</span></span>
                                                            <span className="text-slate-500">{t('staff.design.role_director')}</span>
                                                        </li>
                                                    </ul>
                                                </div>
